...
var ViscousFluidInterpolator = require('./ViscousFluidInterpolator');
var AnimationUtils = require('../animation/AnimationUtils');
...
class Scroller {
  ...
  computeScrollOffset() {
    ...
    var timePassed = AnimationUtils.currentAnimationTimeMillis() - this.mStartTime;
